...
"""
        ...
        prompt_text = "\n".join(convo) + "\n\nOdgovori na hrvatskom jeziku. Koristi samo i isključivo informacije koje se mogu pronaći na web stranici udruge B.a.B.e. Dodaj linkove na kojima se može pronaći više informacija."
